...
//     })
    ...
    // function plusBtnFunction(plusBtnU ,numItemU, priceTagU){
    //     plusBtnU.addEventListener('click', function(){
    //         document.querySelector('plusBtnU').innerText++ ;
    //         numItemU = document.querySelector('plusBtnU').innerText;
    //         document.querySelector('priceTagU').innerText = priceTagU * numItemU;
    //         console.log('numItemU', numItemU)
    //     })
    // }
    // plusBtnFunction(plusBtnA, numItemA, priceTagA);

        function plusBtnFunction(plusBtnU, numItemU, priceTagU){
            plusBtnU.addEventListener('click', function(){
                numItemU.innerText++ ;
                numItemU = numItemU.innerText;
                priceTagU.innerText = priceTagU * numItemU;
                console.log('numItemU', numItemU)
            })
    }
    plusBtnFunction(plusBtnA, numItemA,numItemA, priceTagA);
